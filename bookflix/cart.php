...
if(isset($_POST['update'])){
    ...
    $message[]=''.$user_name.' cập nhập thành công';
}
...
<body>
    ...
    ?>
        ...
        <a href="checkout.php" class="btn cart-btn1" style="display:<?php if($total>1){ echo 'inline-block'; }else{ echo 'none'; };?>" > &nbsp; Tiến hành thanh toán</a> <a class="cart-btn2" href="all_book.php">Tiếp tục mua</a>
    </div>

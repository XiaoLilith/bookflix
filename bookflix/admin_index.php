  ...
  <body >
    ...
    <div class="main_box">
      ...
      <?php
        ...
        <div class="card-body">
          <h5 class="card-title">Số lượng đơn đặt hàng đang chờ xử lý</h5>
          <p class="card-text"> 
      ...
      <?php
        ...
        <div class="card-body">
          <h5 class="card-title">Số lượng đơn hàng đã hoàn thành</h5>
          <p class="card-text">
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          <h5 class="card-title">Số lượng đơn hàng đã nhận</h5>
          <p class="card-text">
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          <h5 class="card-title">Số lượng sách có sẵn</h5>
          <p class="card-text">
          <?php echo $bookscount; ?>
          </p>
          <div class="buttons" style="display: flex;">
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          <h5 class="card-title">Số lượng truy vấn của người dùng</h5>
          <p class="card-text">
          <?php echo $msgcount; ?>
          </p>
      ...
      <div class="card" style="width: 15rem">
        ...
        <div class="card-body">
          <h5 class="card-title">Số lượng người dùng đã đăng ký</h5>
          <p class="card-text">
            <?php echo $usercount; ?>
          </p>
          <a href="users_detail.php" class="btn btn-primary">Chi tiết</a>

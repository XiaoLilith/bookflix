      ...
      <div class="box-container">
         ...
         ?>
               <div class="box">
                  ...
                  <p> Đơn đặt hàng của bạn : <span><?php echo $fetch_book['total_books']; ?></span> </p>
                  <p> Tổng tiền : <span> <?php echo $fetch_book['total_price']; ?> VNĐ</span> </p>
                  <form action="" method="post">
                     ...
                     <input type="submit" value="Cập nhập" name="update_order" class="cart-btn2">
                     <a class="cart-btn1" href="admin_orders.php?delete=<?php echo $fetch_book['order_id']; ?>" onclick="return confirm('delete this order?');">Xóa</a>
                  </form>
               </div>
         <?php
            }

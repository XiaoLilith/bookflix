...
<body>
   ...
   ?>
   <div class="box">
       <div class="name"> ID phản hồi: <?php echo $fetch_user['id']; ?></div>
      ...
      <div class="price">Nội dung: <?php echo wordwrap($fetch_user['msg'],30,"<br>\n",TRUE); ?></div>
      <div class="price">Ngày: <?php echo $fetch_user['date']; ?></div>
      <a href="message_admin.php?delete_msg=<?php echo $fetch_user['id']; ?>" onclick="return confirm('delete this message?');">Xóa</a>
   </div>
   <?php
      }
   }else{
